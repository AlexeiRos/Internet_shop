...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('notebook', 'smartphone', 'television', 'smartwatch')
...
class Product(models.Model):
    ...
    slug = models.SlugField(unique=True)
    image = models.ImageField(upload_to='products/img/%Y/%m/%d', verbose_name='Изображение', blank=True)
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Максимальный объем памяти'
    )
...
class Television(Product):
    ...
    sd = models.BooleanField(default=True, verbose_name='Наличие SD карты')
    extra = models.TextField(verbose_name='Дополнительно', null=True)
...
class Smartwatch(Product):
    ...
    watch_type = models.CharField(max_length=255, verbose_name='Тип')
    operating_system = models.CharField(max_length=255, verbose_name='Операционная система')
    ...
    sensors = models.TextField(verbose_name='Датчики', null=True)
